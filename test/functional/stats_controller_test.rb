...
class StatsControllerTest < ActionController::TestCase
  ...
  test "should create stat" do
    assert_difference('Stat.count') do
      post :create, stat: { arch: @stat.arch, city: @stat.city, count: @stat.count, country_code: @stat.country_code, repo: @stat.repo }
    end
  ...
  test "should update stat" do
    put :update, id: @stat, stat: { arch: @stat.arch, city: @stat.city, count: @stat.count, country_code: @stat.country_code, repo: @stat.repo }
    assert_redirected_to stat_path(assigns(:stat))
  end
